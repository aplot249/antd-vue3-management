  ...
  <div class="home">
      <div >
          ...
          <a-card  hoverable style="width: 400px;"> 
              <template #cover>
              <infocard imgUrl="/src/assets/Avatar.jpg" lastLogin="2021-01-01" nowLogin="2021-01-01" name="教师用户"/>
            </template>
    ...
    <a-card title="我的课程" hoverable style="width: 350px;margin-left: 40px">
      ...
      <div >
        <a-card title="发布课程历史"  hoverable style="width: 450px;margin-left: 40px">
